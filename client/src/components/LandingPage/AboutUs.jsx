...
const AboutUs = ({setAbout}) => {
  return (
    ...
    <main id='content-about-us'>
        <h2>Thank you for visiting our website and also for <a>downloading our app</a>, you're the reason we made this. This app is designed,created and developed by kind hearted W2M members for beautiful people like you.
            ...
            Get in touch with us anytime via our Instagram page- <a>https://www.instagram.com/wave2me2022/</a> and Twitter, also don't forget to tag us on Instagram , and share with your family/friends the signs you've learned! Most importantly,  have fun.
            For further info,questions,or sponsorship -please get in touch with us <a>hello@wave2me.com</a> </h2>
